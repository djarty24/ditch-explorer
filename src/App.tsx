...
export default function App() {
	...
	return (
		<>
			<div className="sm:hidden h-screen w-screen bg-[#0000AA] text-white flex flex-col items-center justify-center p-8 text-center scanlines font-mono">
				<MonitorX size={64} className="mb-6 animate-pulse" />
				<h1 className="text-2xl font-bold bg-white text-[#0000AA] px-2 mb-4">FATAL ERROR</h1>
				<p className="mb-4">A critical exception has occurred at 0028:C0011E36 in VxD.</p>
				<p className="mb-8 font-bold text-yellow-300">SCREEN WIDTH INSUFFICIENT.</p>
				<p className="text-sm">Please insert a quarter, or load this terminal on a desktop computer with a keyboard.</p>
				<p className="text-sm mt-8 animate-pulse">Press any key to continue _</p>
			</div>

			<div className="hidden sm:flex h-screen w-screen flex-col scanlines">
				{isBooting ? (
